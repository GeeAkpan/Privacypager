...
function App() {
  return (
    <section className={ContainerCSS.container}>
      ...
      <p>
        Your continued use of our website will be regarded as acceptance of our practices around privacy and personal information. If you have any questions about how we handle user data and personal information, feel free to <a href="">contact us.</a>
      </p>
      <h3>
        More Information
      </h3>
